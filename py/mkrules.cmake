...
if(MICROPY_FROZEN_MANIFEST)
    ...
    add_custom_target(
        ...
        COMMAND ${Python3_EXECUTABLE} ${MICROPY_DIR}/tools/makemanifest.py
                -o ${MICROPY_FROZEN_CONTENT}
                -v "MPY_DIR=${MICROPY_DIR}"
                -v "MPY_LIB_DIR=${MICROPY_LIB_DIR}"
                -v "PORT_DIR=${MICROPY_PORT_DIR}"
                -v "BOARD_DIR=${MICROPY_BOARD_DIR}"
                -b "${CMAKE_BINARY_DIR}"
                ${MICROPY_CROSS_FLAGS_CONDITIONAL}
                --mpy-tool-flags=${MICROPY_MPY_TOOL_FLAGS}
    ...
    if(MICROPY_CROSS_FLAGS)
        set(MICROPY_CROSS_FLAGS_CONDITIONAL "-f${MICROPY_CROSS_FLAGS}")
    else()
        set(MICROPY_CROSS_FLAGS_CONDITIONAL "")
    endif()
endif()
